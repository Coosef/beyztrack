    ...
    <div :class="classes">
        ...
        <header v-if="! $root.isMobile" class="d-flex flex-wrap justify-content-center py-3 mb-3 border-bottom">
            <router-link to="/dashboard" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                <img class="bi me-2 ms-4" width="40" height="40" src="/icon.png" alt="BeyzTrack Logo" />
                <span class="fs-4 title">{{ $t("BeyzTrack") }}</span>
            </router-link>
                ...
                <li v-if="$root.loggedIn" class="nav-item">
                    <div class="dropdown dropdown-profile-pic">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <router-link to="/backup" class="dropdown-item" :class="{ active: $route.path.includes('backup') }">
                                    <font-awesome-icon icon="save" /> {{ $t("Backup") }}
                                </router-link>
                            </li>
        ...
        <header v-else class="d-flex flex-wrap justify-content-center pt-2 pb-2 mb-3">
            <router-link to="/dashboard" class="d-flex align-items-center text-dark text-decoration-none">
                <img class="bi" width="40" height="40" src="/icon.png" alt="BeyzTrack Logo" />
                <span class="fs-4 title ms-2">BeyzTrack</span>
            </router-link>
        </header>
        ...
        <!-- Mobile Only -->
        <div v-if="$root.isMobile" style="width: 100%; height: calc(120px + env(safe-area-inset-bottom));" />
        <nav v-if="$root.isMobile && $root.loggedIn" class="bottom-nav">
            ...
            <div class="nav-row">
                <router-link to="/todo" class="nav-link">
                    <div><font-awesome-icon icon="tasks" /></div>
                    {{ $t("Yapılacaklar Listesi") }}
                </router-link>

                <router-link to="/reports" class="nav-link">
                    <div><font-awesome-icon icon="chart-bar" /></div>
                    {{ $t("Reports") }}
                </router-link>
