...
const checkVersion = require("./check-version");
        log.info("server", "BeyzTrack Version: " + checkVersion.version);
        ...
        socket.on("setup", async (username, password, callback) => {
            try {
                ...
                if ((await R.knex("user").count("id as count").first()).count !== 0) {
                    throw new Error("BeyzTrack has been initialized. If you want to run setup again, please delete the database.");
                }
