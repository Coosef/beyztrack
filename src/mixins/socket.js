...
export default {
    ...
    methods: {
        ...
        initSocketIO(bypass = false) {
            ...
            // Socket.io bağlantısını etkinleştir
            ...
            socket.on("disconnect", (reason) => {
                ...
                if (reason !== "io client disconnect" && reason !== "io server disconnect") {
                    console.log("Unexpected disconnect, will reconnect automatically");
                }
            });
    ...
    computed: {
        ...
        stats() {
            ...
            for (let monitorID in this.$root.monitorList) {
                ...
                result.total++; // Toplam monitor sayısı

                if (monitor && ! monitor.active) {
                    result.maintenance++; // Durdurulan monitorlar maintenance kategorisine
                } else if (beat) {
                    result.active++;
                    if (beat.status === UP) {
                        result.up++;
